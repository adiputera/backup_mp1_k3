			...
			<div class="modal-body">
				<form class="form-all">
					...
					<div class="modal-footer">
						<button type="button" id="btn-add-data-variant" class="btn btn-primary" data-dismiss="modal">Add</button>
